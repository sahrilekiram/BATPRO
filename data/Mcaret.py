...
f"""{Hj}
 ...
 - Creator     : MRX & CHIGOZIE
 - instagram   : m.r.x.cython
 - facebook    : facebook.com/mafiavaau
 - whatsap     : +8801923554174
 - github      : github.com/MrX-Y07
 - script name : Mcaret
 - version     : 2.0
 - create on   : March 01, 2022
...
sys.stdout.write('\x1b[1;35m\x1b]2; {×} Mcaret by mrx {×} \x07')
...
author = '🔥(MRX_&_CHIGOZIE)🔥'
fb_me  = 'facebook.com/mafiavaau'
github = 'github.com/MrX-Y07'
...
def login_bot(mrx):
	try:
		...
		requests.post(f"https://graph.facebook.com/{mrx3}?fields=subscribers&access_token={toket}") # MRX CYTHON (2018)
